...
class ITK_EXPORT CastVectorImageFileWriter : public ProcessObject
{
public:
  ...
  itkTypeMacro(CastVectorImageFileWriter,ProcessObject);
...
#if !defined(ITK_MANUAL_INSTANTIATION) && !defined(__itkCastVectorImageFileWriter_hxx)
