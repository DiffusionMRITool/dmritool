/*=========================================================================
 ...
 =========================================================================*/
#ifndef __itkCastImageFileWriter_hxx
#define __itkCastImageFileWriter_hxx
...
CastImageFileWriter<TInputImage>
::CastImageFileWriter():
...
//---------------------------------------------------------
template <class TInputImage>
const typename CastImageFileWriter<TInputImage>::InputImageType *
CastImageFileWriter<TInputImage>
::GetInput(void)
{
...
//  if( strcmp( input->GetNameOfClass(), "VectorImage" ) == 0 ) 
  ...
  // Writer typedefs
  typedef Image<unsigned char, TInputImage::ImageDimension>   UCharImageType;
  typedef Image<char, TInputImage::ImageDimension>            CharImageType;
  typedef Image<unsigned short, TInputImage::ImageDimension>  UShortImageType;
  typedef Image<short, TInputImage::ImageDimension>           ShortImageType;
  typedef Image<unsigned int, TInputImage::ImageDimension>    UIntImageType;
  typedef Image<int, TInputImage::ImageDimension>             IntImageType;
  typedef Image<unsigned long, TInputImage::ImageDimension>   ULongImageType;
  typedef Image<long, TInputImage::ImageDimension>            LongImageType;
  typedef Image<float, TInputImage::ImageDimension>           FloatImageType;
  typedef Image<double, TInputImage::ImageDimension>          DoubleImageType;
