...
#ifndef __itkRGBImageToVTKImageDataFilter_h
#define __itkRGBImageToVTKImageDataFilter_h
...
class ITK_EXPORT RGBImageToVTKImageDataFilter : public ProcessObject
{
public:
  ...
  itkTypeMacro(RGBImageToVTKImageDataFilter, ProcessObject);
...
private:
  RGBImageToVTKImageDataFilter(const Self&); //purposely not implemented
...
#include "itkRGBImageToVTKImageDataFilter.hxx"
#endif
