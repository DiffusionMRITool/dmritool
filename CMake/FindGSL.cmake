...
#
#  Note: if BLAS_LIBRARIES is found, then use it as gslcblas, because normally cblas in gsl is inefficient. 
#
...
if( WIN32 AND NOT CYGWIN AND NOT MSYS )
  ...
  if( GSL_INCLUDE_DIR )
    ...
    if (${BLAS_FOUND})
      set (GSL_CBLAS_LIBRARY ${BLAS_LIBRARIES})
    else ()
  ...
  if( UNIX OR MSYS )
    ...
    if(NOT GSL_CONFIG_EXECUTABLE_DIR)
      set(GSL_CONFIG_EXECUTABLE_DIR "" CACHE PATH "GSL bin directory containing gsl-config")
    endif(NOT GSL_CONFIG_EXECUTABLE_DIR)

    find_program( GSL_CONFIG_EXECUTABLE gsl-config
      /usr/bin/
      /usr/local/bin
      ${GSL_CONFIG_EXECUTABLE_DIR}
    )
    ...
    if( GSL_CONFIG_EXECUTABLE )
      ...
      if( RET EQUAL 0 )
        ...
        if (${BLAS_FOUND})
          set(GSL_LIBRARIES ${GSL_LIBRARIES} ${BLAS_LIBRARIES})
        endif()
      ...
      set( GSL_CONFIG_EXECUTABLE_DIR ${GSL_PREFIX}/bin CACHE PATH "GSL bin directory containing gsl-config" FORCE )
