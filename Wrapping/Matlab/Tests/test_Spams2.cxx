...
template <typename T>
   inline void callFunction(mxArray* plhs[], const mxArray*prhs[]) {
      if (!utl::mexCheckType<T>(prhs[0])) 
         mexErrMsgTxt("type of argument 1 is not consistent");
      if (mxIsSparse(prhs[0])) 
         mexErrMsgTxt("argument 1 should be full");
      if (!utl::mexCheckType<T>(prhs[1])) 
      ...
      T lambda = utl::GetScalarStruct<T>(prhs[3],"lambda");
      int L = utl::GetScalarStructDef<int>(prhs[3],"L",K);
      int numThreads = utl::GetScalarStructDef<int>(prhs[3],"numThreads",-1);
      bool pos = utl::GetScalarStructDef<bool>(prhs[3],"pos",false);
      spams::constraint_type mode = (spams::constraint_type)utl::GetScalarStructDef<int>(prhs[3],"mode",spams::PENALTY);
      if (L > n) {
      ...
      spams::Matrix<T> X(prX,n,M);
      spams::Matrix<T> D(prD,n,K);
      ...
      spams::Matrix<T> weight(prWeight,KK,MM);
      
      spams::SpMatrix<T> alpha;
      spams::lassoWeight<T>(X,D,weight,alpha,L,lambda,mode,pos,numThreads);
      utl::ConvertSpMatrix(plhs[0],alpha.m(),alpha.n(),alpha.n(),
