#ifndef CBLAS_DEFVAR_H
#define CBLAS_DEFVAR_H
#include <stddef.h>

/*
 * Enumerated and derived types
 */
#if !defined(CBLAS_H) && !defined(__GSL_CBLAS_H__) && !defined(CBLAS_ENUM_DEFINED_H) && !defined(__MKL_CBLAS_H__)     // this part conflicts with gsl_cblas.h
...
inline char *cblas_transpose(CBLAS_TRANSPOSE TransA)
{
	switch(TransA)
	{
    ...
    case 114: return &CBLAS_TRANSPOSE_CHAR[3];
#endif
	}
	return NULL;
}
...
inline char *cblas_uplo(CBLAS_UPLO Uplo)
{
	switch(Uplo)
	{
...
inline char *cblas_diag(CBLAS_DIAG Diag)
{
	switch(Diag)
	{
...
inline char *cblas_side(CBLAS_SIDE Side)
{
	switch(Side)
	{
